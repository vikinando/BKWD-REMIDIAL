...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2023 at 01:25 PM
...
INSERT INTO `dokter` (`id`, `nama_dokter`, `alamat`, `no_hp`, `id_poli`, `nip`, `password`) VALUES
(2, 'Abdul Latif', 'Tembalang, Semarang', '081234567890', 1, 'd12345', '$2y$10$pEySZA.snpb8rjsMSa06Ke7IuVidq7xpJISjjuIDlfiqx70Jv18VS');
...
(2, 'Sanmol', 'Botol', 15000),
(3, 'Mylanta', 'Botol', 20000),
(4, 'Antimo', 'Strip', 7500);
...
(1, 'Poli Gigi', 'Tempat pemeriksaan gigi');
...
(1, '', 'yusufisa', '$2y$10$Nwyc1n/YFJQp1J79XVIfme3flSEUu90er8rjdkqvxbpQ4MGNKBQgG'),
(2, 'Yusuf Isa', 'ysfisa', '$2y$10$FrDSx3soJXXdoPcxNprFLeRHEiYRbQeuXFLnUW9Qn6Cc0A6jthL7y');
