...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($password === $confirm_password) {
        ...
        if ($result->num_rows == 0) {
            ...
            $insert_query = "INSERT INTO user (nama_user, username, password) VALUES ('$nama_user', '$username', '$hashed_password')";
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=registerUser">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_user" class="form-control" required placeholder="Masukkan nama anda">
                        </div>
                        <div class="form-group">
