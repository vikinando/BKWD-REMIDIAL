...
<head>
    ...
    <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/poliveno/dist/css/welcome_styles.css">
</head>
...
<body>
    ...
    ?>
        <!-- Header-->
        <header class="py-5" style="background-color: #ff8c00;"> <!-- Ubah Color Banner disini -->
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2">Sistem Daftar Janji <br>Pasien - Dokter</h1>
